import { defineMapPlanningElement } from "./map-planning.js";
...
export async function activate(context: AddonContext): Promise<Disposable> {
  context.capabilities.require("data.transactions"); context.capabilities.require("ui.contributions"); context.capabilities.require("ui.markdown"); context.capabilities.require("ui.controls.v1"); context.signal.throwIfAborted();
